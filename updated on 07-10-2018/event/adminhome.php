...
<nav aria-label="breadcrumb">
  ...
  <p style="color:grey; margin-left:85%; margin-top:-18px">hai...!!!<?php echo $mid1;?></p>  
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
						...
						<div class="col-md-3" style=" border-spacing: 20px;">
                        ...
                        <div class="col-md-3">
                          <a href="#" class="btn btn-success btn-lg" role="button"><span class="glyphicon glyphicon-user"></span> <br/>Users</a>
						   ...
						   <div class="col-md-3">
                          <a href="album_view.php" class="btn btn-info btn-lg" role="button"><span class="glyphicon glyphicon-file"></span> <br/>Gallery</a>
						  </div>
						   <div class="col-md-3">
                          <a href="addalbum.php" class="btn btn-primary btn-lg" role="button"><span class="glyphicon glyphicon-picture"></span> <br/>Photos</a>
						  </div>
						   <div class="col-md-3">
